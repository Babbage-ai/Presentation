...
<head>
    ...
    <style>
        ...
        .quiz-row { display: flex; align-items: center; justify-content: space-between; gap: 0.9rem; padding: 0.8rem 0.9rem; border-top: 1px solid var(--admin-border); cursor: pointer; transition: background-color 0.16s ease; }
